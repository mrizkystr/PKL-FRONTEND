    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem button onClick={() => navigate("/data-ps")}>
            <ListItemIcon>
              <ListAlt />
            </ListItemIcon>
            <ListItemText primary="Data PS" />
          </ListItem>
          <ListItem button onClick={() => navigate("/sales-codes")}>
            <ListItemIcon>
              <Code />
            </ListItemIcon>
          ...
          <Collapse in={openStoChart} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sto-pie-chart")}
              >
                <ListItemIcon>
                  <PieChart />
                </ListItemIcon>
          ...
          <Collapse in={openMitraChart} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/mitra-bar-chart")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/mitra-pie-chart")}
              >
                <ListItemIcon>
                  <PieChart />
                </ListItemIcon>
          ...
          <Collapse in={openPsAnalysis} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/ps-analysis/month")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/ps-analysis/code")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/ps-analysis/mitra")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/data-ps/day/analysis")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
          ...
          {/* Target Tracking */}
          <ListItem button onClick={() => navigate("/data-ps/target/tracking")}>
            <ListItemIcon>
              <Analytics />
            </ListItemIcon>
