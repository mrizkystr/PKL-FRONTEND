    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem button onClick={() => navigate("/sales/sales-codes")}>
            <ListItemIcon>
              <Code />
            </ListItemIcon>
          ...
          <Collapse in={openStoChart} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/sto-chart")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/sto-pie-chart")}
              >
                <ListItemIcon>
                  <PieChart />
                </ListItemIcon>
          ...
          <Collapse in={openMitraChart} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/mitra-bar-chart")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/mitra-pie-chart")}
              >
                <ListItemIcon>
                  <PieChart />
                </ListItemIcon>
          ...
          <Collapse in={openPsAnalysis} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/ps-analysis/month")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/ps-analysis/code")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/ps-analysis/mitra")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
              ...
              <ListItem
                button
                sx={{ pl: 4 }}
                onClick={() => navigate("/sales/data-ps/day-analysis")}
              >
                <ListItemIcon>
                  <BarChart />
                </ListItemIcon>
          ...
          {/* Target Tracking */}
          <ListItem button onClick={() => navigate("/sales/data-ps/target/tracking")}>
            <ListItemIcon>
              <Analytics />
            </ListItemIcon>
