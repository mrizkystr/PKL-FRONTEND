...
import { dataPsApi } from "../../api/api"; // Adjust the import path as necessary

const StoAnalysisPage = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () => dataPsApi.getStoAnalysis({ sto: selectedSto, view_type: viewType }),
...
export default StoAnalysisPage;
