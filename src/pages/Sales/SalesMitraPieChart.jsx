...
const SalesMitraPieChart = () => {
  ...
  const {
    ...
    queryKey: ["salesMitraPieChart", selectedMonth, selectedSto],
    queryFn: async () => {
      try {
        const response = await salesApi.dataPsApi.getMitraPieChart({
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Container maxWidth="xl" sx={{ ml: 3 }}>
        {" "}
        {/* Tambahkan margin kiri untuk layout */}
        <Box sx={{ mt: 4, mb: 4 }}>
...
export default SalesMitraPieChart;
