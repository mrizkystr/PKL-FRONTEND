...
import { userApi } from "../../api/api"; // Adjust the import path as necessary

const UserStoAnalysis = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () => userApi.dataPsApi.getStoAnalysis({ sto: selectedSto, view_type: viewType }),
...
export default UserStoAnalysis;
